  ...
  return (
    <div className={styles['modal-content']}>
      <div className={styles['modal-detail']}>
        <p>
          <span>1. 말린 꼬리</span> : 고리처럼 동그랗게 등 쪽으로 말려 있는 꼬리
        </p>
        <img src={Tail1} alt="" />
      </div>
      <div className={styles['modal-detail']}>
        <p>
          <span>2. 수달 꼬리</span> : 크고 두꺼운 C자 모양으로 밑동은 두껍고, 끝으로 갈수록 가늘어지는 꼬리
        </p>
        <img src={Tail2} alt="" />
      </div>
      <div className={styles['modal-detail']}>
        <p>
          <span>3. 당근 꼬리</span> : 수달꼬리와 비슷하게 밑동은 두껍고 끝은 가는 형태지만 더 가늘고 끝이 뾰족한 꼬리
        </p>
        <img src={Tail3} alt="" />
      </div>
      <div className={styles['modal-detail']}>
        <p>
          <span>4. 단발 꼬리</span> : 아주 짧거나 거의 없는 형태의 꼬리
        </p>
        <img src={Tail4} alt="" />
      </div>
    </div>
